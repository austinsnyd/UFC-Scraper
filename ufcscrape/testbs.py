...
if __name__ == "__main__":
    driver = init_driver()
    test_fight_link = "http://www.ufcstats.com/fight-details/406f2aacd1d1faf9"
    result_df = scrape_fight_details(driver, test_fight_link)
    print(result_df.head())  # Inspect the first few rows of the result
    driver.quit()
